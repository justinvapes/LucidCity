...
local blackjackTables = {
    ...
    GetHashKey("h4_prop_casino_3cardpoker_01b"),
    GetHashKey("h4_prop_casino_blckjack_01e"),
}
...
cfg.blackjackTables = {
    --[id] = {x,y,z,heading}
    [0] = {
        dealerPos = vector3(1001.96, 59.81, 69.43),
        dealerHeading = 322.67,
        tablePos = vector3(1002.383, 60.50793, 68.43275),
        tableHeading = 143.309,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01"
    },
    [1] = {
        dealerPos = vector3(1003.43, 53.61, 69.43),
        dealerHeading = 237.93,
        tablePos = vector3(1004.184, 53.19, 68.43 + 0.0018),
        tableHeading = 58.30,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01"
    },
    [2] = {
        dealerPos = vector3(996.83, 52.40, 69.43),
        dealerHeading = 142.42,
        tablePos = vector3(996.34, 51.73, 68.43 + 0.0018),
        tableHeading = 322.99,
        distance = 1000.0,
        prop = "vw_prop_casino_3cardpoker_01"
    },
    [3] = {
        dealerPos = vector3(995.64, 57.86, 69.43),
        dealerHeading = 61.42,
        tablePos = vector3(994.90, 58.21, 68.43 + 0.0018),
        tableHeading = 243.00,
        distance = 1000.0,
        prop = "vw_prop_casino_3cardpoker_01"
    },
    [4] = {
        dealerPos = vector3(986.47, 42.01, 70.23),
        dealerHeading = 275.71,
        tablePos = vector3(987.26, 42.20, 69.23 + 0.0018),
        tableHeading = 103.30,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b"
    },
    [5] = {
        dealerPos = vector3(988.67, 46.45, 70.23),
        dealerHeading = 200.42,
        tablePos = vector3(989.03, 45.72, 69.23 + 0.0018),
        tableHeading = 23.30,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b"
    },
    [6] = {
        dealerPos = vector3(986.08, 59.75, 70.23),
        dealerHeading = 5.0,
        tablePos = vector3(985.90, 60.55, 69.23 + 0.0018),
        tableHeading = 188.30,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b"
    },
    [7] = {
        dealerPos = vector3(981.65, 62.62, 70.23),
        dealerHeading = 283.42,
        tablePos = vector3(982.48, 62.90, 69.23 + 0.0018),
        tableHeading = 103.30,
        distance = 1000.0,
        prop = "vw_prop_casino_blckjack_01b"
    },
    [8] = {
        dealerPos = vector3(-374.45, 211.97, 81.30),
        dealerHeading = 175.02,
        tablePos = vector3(-374.5807, 211.14, 80.31 + 0.0018),
        tableHeading = 0.05,
        distance = 1000.0,
        prop = "h4_prop_casino_3cardpoker_01b"
    },
    [9] = {
        dealerPos = vector3(-369.18, 209.1469, 81.30),
        dealerHeading = 358.48,
        tablePos = vector3(-369.23, 210.00, 80.30 + 0.0018),
        tableHeading = 180.05,
        distance = 1000.0,
        prop = "h4_prop_casino_blckjack_01e"
    },
    [10] = {
        dealerPos = vector3(-369.26, 208.41, 81.30),
        dealerHeading = 175.90,
        tablePos = vector3(-369.24, 207.57, 80.31 + 0.0018),
        tableHeading = 359.65,
        distance = 1000.0,
        prop = "h4_prop_casino_blckjack_01e"
    }
...
RegisterCommand("getcasinotable",function()
    ...
    local blackjackTable = GetClosestObjectOfType(playerCoords.x,playerCoords.y,playerCoords.z,GetEntityHeading(PlayerPedId()),1152516847,0,0,0)
    if false then
        print("Found entity")
        ...
        local blackjackTable2 = GetClosestObjectOfType(playerCoords.x,playerCoords.y,playerCoords.z,GetEntityHeading(PlayerPedId()),1284693927,0,0,0)
...
function resetDealerIdle(dealerPed)
    ...
    if DoesEntityExist(dealerPed) then
        ...
        --pront("playing idle animation: " .. tostring(genderAnimString .. "idle"))
...
Citizen.CreateThread(function()
    while true do 
        ...
        if drawCurrentHand then 
            ...
            DrawAdvancedNativeText(1.028, 0.93, 0.005, 0.0028, 0.364, "You: "..tostring(currentHand).." | Dealer: "..tostring(dealersHand).."", 255, 255, 255, 255, 0, 0)
            --DrawAdvancedNativeText(1.041, 0.928, 0.005, 0.0028, 0.464, "Dealer's hand: "..tostring(dealersHand).."", 255, 255, 255, 255, 0, 0)
        end
        Wait(0)
    end
end)
...
AddEventHandler("Blackjack:successBlackjackBet",function()
    ...
    --pront("waitingForBetState = false from submitted bet")
    blackjackInstructional = nil
    --pront("made blackjackInstructional nil cause its success")
end)
...
RegisterNetEvent("DiamondBlackjack:SitChair")
AddEventHandler("DiamondBlackjack:SitChair", function()
...
Citizen.CreateThread(function()
    while true do 
        if closeToCasino then
            ...
            --pront("closestChair = ",closestChair)
        end
        Wait(100)
    end
end)
...
AddEventHandler("Blackjack:beginBetsBlackjack",function(gameID,tableId)
    ...
    --pront("made blackjackInstructional true cause its intro time bet")
    ClearHelp(true)
    ...
    --pront("waitingForBetState = true from beginbets")
    ...
    Citizen.CreateThread(function()
        ...
        if not bettedThisRound then
            --pront("made blackjackInstructional nil cause you didnt bet")
...
AddEventHandler("Blackjack:beginCardGiveOut",function(gameId,cardData,chairId,cardIndex,gotCurrentHand,tableId)
    if closeToCasino then
        ...
        --pront("Blackjack:beginCardGiveOut",gameId,cardData,chairId,cardIndex,gotCurrentHand,tableId)
                ...
                if sittingAtBlackjackTable then
                    ...
                    while timeLeft > 0 do 
                        ...
                        if standOrHitThisRound then
                            --pront("terminating standorhit timer thread")
                            timeLeft = 20
                            drawTimerBar = false
                            return
                            --pront("failed it didnt terminate!")
                        end
                        Wait(1000)
                    end
                end
                if not standOrHitThisRound and sittingAtBlackjackTable then
                    --pront("you took too long fam standing shit")
                    waitingForStandOrHitState = false
                    TriggerServerEvent("Blackjack:standBlackjack",globalGameId,globalNextCardCount)
                    declineCard()
...
function getClosestDealer()
    ...
    for k,v in pairs(dealerPeds) do 
        local dealerPed = v
        --pront("Entity ID of this dealer ped: " .. tostring(dealerPed))
        local distanceToDealer = #(playerCoords - GetEntityCoords(dealerPed))
        --pront("Distance to dealer ped: " .. tostring(distanceToDealer))
    ...
    --pront("Closest dealer ped is: " .. tostring(tmpclosestDealerPed))
...
function goToBlackjackSeat(blackjackSeatID)
    ...
    --pront("[CMG Casino] start sit at blackjack seat") 
    ...
    --pront("[CMG Casino] blackjack anims loaded") 
    Local_198f_247 = blackjackSeatID
    --pront("blackjackSeatID: " .. blackjackSeatID)
    ...
    --pront("[CMG Casino] walking to seat, x: " .. tostring(walkToVector.x) .. " y: " .. tostring(walkToVector.y) .. " z: " .. tostring(walkToVector.z))
    ...
    --pront("[CMG Casino] Blackjack sit at table net scene starting")
    --pront("[CMG Casino] creating Scene at, x: " .. tostring(goToVector.x) .. " y: " .. tostring(goToVector.y) .. " z: " .. tostring(goToVector.z))
    ...
    --pront("[CMG Casino] Blackjack sit at table net scene started")
...
function startSingleDealerDealing(dealerPed,gameId,cardData,nextCardCount,gotCurrentHand,chairId,tableId)
    --pront("startSingleDealerDealing", chairId)
    ...
    --pront("dealerPed: " .. tostring(dealerPed))
    --pront("DoesEntityExist(dealerPed): " .. tostring(DoesEntityExist(dealerPed)))
    --pront("NetworkHasControlOfEntity(dealerPed): " .. tostring(NetworkHasControlOfEntity(dealerPed)))
    local gender = getDealerGenderFromPed(dealerPed)
    --pront("getLocalChairIdFromGlobalChairId: " .. tostring(getLocalChairIdFromGlobalChairId))
    if DoesEntityExist(dealerPed) then
        ...
        --pront("blackjack_func_368(closestChair)",blackjack_func_368(closestChair))
        --pront("tableId",tableId)
        ...
        --pront("Failed to deal cards, entity doesn't exist or we don't have control")
    end
end
...
function startSingleDealing(chairId,dealerPed,gameId,cardData,nextCardCount,gotCurrentHand)
    ...
    if DoesEntityExist(dealerPed) then
        ...
        local soundCardString = "MINIGAME_BJACK_DEALER_" .. tostring(gotCurrentHand)
        --pront("trying soundString: " .. tostring(soundCardString))
        PlayAmbientSpeech1(dealerPed,soundCardString,"SPEECH_PARAMS_FORCE_NORMAL_CLEAR",1)
        vVar8 =  vector3(0.0, 0.0, getTableHeading(blackjack_func_368(chairId)))
        local tablePosX,tablePosY,tablePosZ = getTableCoords(blackjack_func_368(chairId))
        local cardQueue = cardPosition -- number of card
        ...
        if iVar9 <= 4 then
            --pront("single card pos: " .. tostring(iVar5)) 
...
function startDealing(dealerPed,gameId,cardData,chairId,cardIndex,gotCurrentHand,fakeChairIdForDealerTurn)
    ...
    local gender = getDealerGenderFromPed(dealerPed)
    if DoesEntityExist(dealerPed) then
        --pront("startDealing() - entityExists")
        --pront("request cardId: " .. tostring(cardData[cardIndex])) 
        ...
        if chairId <= 1000 then
            --pront("[blackjack] giving player cards")
            dealerGiveCards(chairId,genderAnimString,dealerPed,nextCardObj) 
        else 
            --pront("[blackjack] giving dealers cards")
        ...
        local cardPos = GetObjectOffsetFromCoords(tablePosX, tablePosY, tablePosZ, vVar8.z, cardOffsetX, cardOffsetY, cardOffsetZ)
        SetEntityCoordsNoOffset(nextCardObj, cardPos.x, cardPos.y, cardPos.z, 0, 0, 1)
        --pront("fakeChairIdForDealerTurn",fakeChairIdForDealerTurn)
        if chairId <= 1000 then
            vVar8 =  vector3(0.0, 0.0, getTableHeading(blackjack_func_368(chairId))) 
        ...
        --pront("checking betttingInstructional",closestChair,chairId)
...
function startStandOrHit(gameId,dealerPed,chairId,actuallyPlaying)
    ...
    --pront("dealerPed: " .. tostring(dealerPed))
    --pront("chairAnimId: " .. tostring(chairAnimId))
    --pront("genderAnimString: " .. tostring(genderAnimString))
    ...
    while IsEntityPlayingAnim(dealerPed, "anim_casino_b@amb@casino@games@blackjack@dealer", genderAnimString .. "dealer_focus_player_0" .. chairAnimId .. "_idle_intro") do 
        Wait(10)
        --pront("waiting for anim to end #1")
    end
...
function flipDealerCard(dealerPed,gotCurrentHand,tableId,gameId)
    ...
    while not HasAnimEventFired(dealerPed,-1345695206) do
        --pront("waiting for -1345695206 to fire")
        Wait(0)
    end
...
AddEventHandler("Blackjack:endStandOrHitPhase",function(chairId,tableId)
    if closeToCasino then
        ...
        --pront("dealer ending anim: " .. "anim_casino_b@amb@casino@games@blackjack@dealer", genderAnimString .. "dealer_focus_player_0" .. chairAnimId .. "_idle_outro")
...
AddEventHandler("Blackjack:bustBlackjack",function(chairID,tableId)
    if closeToCasino then
        ...
        --pront("closestChair:",closestChair)
        --pront("getLocalChairIdFromGlobalChairId(closestChair):",getLocalChairIdFromGlobalChairId(closestChair))
        --pront("chairID+1:",chairID)
        --pront("sittingAtBlackjackTable:",sittingAtBlackjackTable)
...
function betChipsForNextHand(chipsAmount,chipsProp,something,chairID,someBool,zOffset)
    ...
    -- }
    --pront("betChipsForNextHand",chairID)
    --pront("betChipsForNextHand_local",getLocalChairIndexFromGlobalChairId(chairID))
    RequestModel(chipsProp)
    while not HasModelLoaded(chipsProp) do  
        Wait(0)
        --pront("[CMG Casino] Stuck requesting model: " .. tostring(chipsProp))
        RequestModel(chipsProp)
    end
    vVar8 =  vector3(0.0, 0.0, getTableHeading(blackjack_func_368(chairID)))
    local tablePosX,tablePosY,tablePosZ = getTableCoords(blackjack_func_368(chairID))
    ...
    --pront("betChips DEBUG")
    --pront("==============")
    --pront("zOffset: " .. tostring(zOffset))
    --pront("vVar8: " .. tostring(vVar8))
    --pront("tablePosX: " .. tostring(tablePosX))
    --pront("tablePosY: " .. tostring(tablePosY))
    --pront("tablePosZ: " .. tostring(tablePosZ))
    --pront("chipsVector: " .. tostring(chipsVector))
    --pront("chipsOffset: " .. tostring(chipsOffset))
    --pront("chipsObj: " .. tostring(chipsObj))
    --pront("chipOffsetRotation: " .. tostring(chipOffsetRotation))
end 
...
function getNewCardFromMachine(nextCard,chairId,gameId)
    ...
    if cardObjects[chairId] ~= nil then 
        if gameId then
            --pront("inserting chipsobjects with key: " .. tostring(gameId))
            table.insert(cardObjects[gameId],nextCardObj)
        else
            --pront("inserting chipsobjects with key: " .. tostring(chairId))
    ...
    --end
    --pront("cardObjectOffsetRotation.x: " .. tostring(cardObjectOffsetRotation.x))
    --pront("cardObjectOffsetRotation.y: " .. tostring(cardObjectOffsetRotation.y))
    --pront("cardObjectOffsetRotation.z: " .. tostring(cardObjectOffsetRotation.z))
    SetEntityRotation(nextCardObj, cardObjectOffsetRotation.x, cardObjectOffsetRotation.y, cardObjectOffsetRotation.z, 2, 1)
...
function dealerGiveCards(chairId,gender,dealerPed,cardObj) --func_36
    ...
    while not HasAnimEventFired(dealerPed, 585557868) do 
        Wait(0)
        --pront("waiting for anim event to fire.. for dealergivecards")
    end 
end
...
function dealerGiveSelfCard(gender,dealerPed,cardIndex,cardObj) --func_36
    ...
    while not HasAnimEventFired(dealerPed, 585557868) do 
        Wait(0)
        --pront("waiting for anim event to fire.. for dealerGiveSelfCard")
    end
    Wait(100)
end
...
function blackjack_func_399(iParam0) --iParam0 is table ID?
    ...
    --pront("func_399 iParam0",iParam0)
...
function blackjack_func_348(iParam0) --GetVectorFromChairId
    ...
    if DoesEntityExist(blackjackTableObj) and DoesEntityHaveDrawable(blackjackTableObj) then
        ...
        --pront("localchairId was",localChairId)
        localChairId = getInverseChairId(localChairId) + 1
        --pront("localchairId is now",localChairId)
...
function blackjack_func_377(iParam0, iParam1, bParam2) --iVar5, iVar9, 0
    --pront("blackjack_func_377")
    --pront("iParam0: " .. tostring(iParam0))
    --pront("iParam1: " .. tostring(iParam1))
    --pront("bParam2: " .. tostring(bParam2))
    if bParam2 == 0 then 
        --pront("first check [OK]")
        --pront("iParam1: " .. tostring(iParam1))
        --pront("iParam0: " .. tostring(iParam0))
		if iParam1 == 0 then
            if iParam0 == 0 then
...
function blackjack_func_374(betAmount, iParam1, chairId, bParam3) --returns vector3
    ...
    --pront("blackjack_func_374 params:")
    --pront("betAmount: " .. tostring(betAmount))
    --pront("iParam1: " .. tostring(iParam1))
    --pront("chairId: " .. tostring(chairId))
    --pront("bParam3: " .. tostring(bParam3))
    fVar0 = 0.0
    vVar1 = vector3(0,0,0)
    if not bParam3 then 
        --pront("now checking betAmount: " .. tostring(betAmount))
...
--     --pront("animation started")
--     -- while not HasEntityAnimFinished(GetPlayerPed(-1), "anim_casino_b@amb@casino@games@blackjack@dealer", "check_card",3) do 
--     --     --pront("waiting for check card animation to end")
--     --     Wait(0)
--     -- end
--     while true do 
--         --pront("hasAnimEventFired: " .. tostring(HasAnimEventFired(GetPlayerPed(-1),585557868)))
--         Wait(0)
--     end
--     --pront("animation finished")
-- end)

-- RegisterCommand("debugblackjack", function()
--     --pront("closestBlackjackChair: " .. tostring(closestChairDist))
--     --pront("closestChair: " .. tostring(closestChair))
--     --pront("Local_198f_247: " .. tostring(Local_198f_247))
-- end)
...
--     local chips = args[2]
--     --pront("getChipPropFromAmount(" .. tostring(chips) .. ")")
...
AddEventHandler("scCore:client:LoadInteractions", function()
    exports["lcrp-interact"]:AddTargetModel(blackjackTables, {
      options = {
          {
              event = "DiamondBlackjack:SitChair",
              icon = "fas fa-spade",
