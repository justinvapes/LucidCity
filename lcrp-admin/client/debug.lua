-- CREDITS TO KOIL FOR DEBUG SCRIPT.
    ...
    while true do 
        ...
        if dickheaddebug then
            ...
            if IsControlJustReleased(0, 38) then
                if inFreeze then
                    inFreeze = false
                    scCore.Notification("Freeze Disabled")         
                else
                    inFreeze = true             
                    scCore.Notification("Freeze Enabled")     
                end
            end
            ...
            if IsControlJustReleased(0, 47) then
                if lowGrav then
                    lowGrav = false
                    scCore.Notification("Low Grav Disabled")           
                else
                    lowGrav = true     
                    scCore.Notification("Low Grav Enabled")                       
                end
            end
