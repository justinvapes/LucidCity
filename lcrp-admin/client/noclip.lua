...
RegisterNetEvent('lcrp-admin:client:toggleNoclip')
AddEventHandler('lcrp-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            scCore.Notification("Current speed: ".. speeds[travelSpeed])
