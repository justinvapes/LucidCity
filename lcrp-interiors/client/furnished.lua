...
RegisterNetEvent('lcrp-interiors:client:SetNewState')
AddEventHandler('lcrp-interiors:client:SetNewState', function(bool)
	IsNew = bool
end)
...
function CreateApartmentFurnished(spawn)
	...
	if IsNew then
		SetTimeout(750, function()	
			TriggerEvent("raid-clothes:OpenClothesMenu")
			IsNew = false
		end)
	end
    return { objects, POIOffsets }
