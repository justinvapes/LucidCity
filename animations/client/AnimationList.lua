...
AnimationList.Emotes = {
   ...
   ["research"] = {"amb@prop_human_bbq@male@idle_a", "idle_b", "Research", AnimationOptions =
   {
        EmoteLoop = true,
   }},
   ...
   ["k9bark"] = {"creatures@rottweiler@amb@world_dog_barking@idle_a", "idle_a", "K9-Bark", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["k9down"] = {"creatures@rottweiler@amb@sleep_in_kennel@", "sleep_in_kennel", "K9-LayDown", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["k9sit"] = {"creatures@rottweiler@amb@world_dog_sitting@base", "base", "K9-Sit", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["k9itch"] = {"creatures@rottweiler@amb@world_dog_sitting@idle_a", "idle_a", "K9-Itch", AnimationOptions =
   {
       EmoteDuration = 4000,
       EmoteMoving = false,
   }},
   ["k9attention"] = {"creatures@rottweiler@indication@", "indicate_ahead", "K9-Attention", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["k9taunt"] = {"creatures@rottweiler@melee@streamed_taunts@", "taunt_01", "k9-Taunt", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false, 
   }},
   ["k9beg"] = {"creatures@rottweiler@tricks@", "beg_loop", "K9-Beg", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ["k9paw"] = {"creatures@rottweiler@tricks@", "paw_right_loop", "K9-Paw", AnimationOptions =
   {
       EmoteLoop = true,
       EmoteMoving = false,
   }},
   ...
   ["pickup2"] = {"pickup_object", "putdown_low", "Pickup 2"},
   ["fill"] = {"amb@prop_human_parking_meter@male@idle_a", "idle_a", "Fill"},
   ...
   ["strip"] = {"mini@strip_club@lap_dance@ld_girl_a_song_a_p1", "ld_girl_a_song_a_p1_f", "Strip Tease 1", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ...
   ["strip4"] = {"mini@strip_club@idles@stripper", "stripper_idle_02", "Strip Tease 4", AnimationOptions =
   {
       EmoteLoop = true,
   }},
   ["strip5"] = {"mini@strip_club@backroom@", "stripper_b_backroom_idle_b", "Strip Tease 5", AnimationOptions =
   {
       EmoteLoop = true,
   }},
...
-----------------------------------------------------------------------------------------------------------
   ...
   ["hooker"] = {"Scenario", "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", "Hooker"},
...
-----------------------------------------------------------------------------------------------------
   ...
   ["pc"] = {"anim@heists@box_carry@", "idle", "PC", AnimationOptions =
   {
       Prop = "v_res_pctower",
       PropBone = 60309,
       PropPlacement = {-0.1, 0.0, 0.255, 80.0, 0.0, 130.0},
       EmoteLoop = true,
       EmoteMoving = true,
       AllowedCommand = false,
   }},
   ["tv1"] = {"anim@heists@box_carry@", "idle", "CRT TV", AnimationOptions =
   {
       Prop = "prop_tv_02",
       PropBone = 60309,
       PropPlacement = {0.0, 0.0, 0.270, 0.0, 0.0, 0.0},
       EmoteLoop = true,
       EmoteMoving = true,
       AllowedCommand = false,
   }},
   ["tv2"] = {"anim@heists@box_carry@", "idle", "Flat TV", AnimationOptions =
   {
       Prop = "prop_tv_flat_02b",
       PropBone = 60309,
       PropPlacement = {-0.1, 0.10, 0.255, 150.0, 120.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
       AllowedCommand = false,
   }},
   ["painting1"] = {"anim@heists@box_carry@", "idle", "Cheap Painting", AnimationOptions =
   {
       Prop = "h4_prop_h4_painting_01e",
       PropBone = 60309,
       PropPlacement = {0.1, 0.0, 0.255, 150.0, 100.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
       AllowedCommand = false,
   }},
   ["painting2"] = {"anim@heists@box_carry@", "idle", "Painting", AnimationOptions =
   {
       Prop = "ch_prop_vault_painting_01b",
       PropBone = 60309,
       PropPlacement = {0.1, 0.0, 0.255, 150.0, 100.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
   ...
   ["painting3"] = {"anim@heists@box_carry@", "idle", "Expensive Painting", AnimationOptions =
   {
   ...
   ["bust"] = {"anim@heists@box_carry@", "idle", "Expensive Bust", AnimationOptions =
   {
       Prop = "v_corp_bk_bust",
       PropBone = 60309,
       PropPlacement = {-0.1, 0.5, 0.4, 120.0, 120.0, 180.0},
       EmoteLoop = true,
       EmoteMoving = true,
       AllowedCommand = false,
   }},
   ["laundry"] = {"anim@heists@box_carry@", "idle", "Laundry", AnimationOptions =
   {
       Prop = "v_res_mlaundry",
       PropBone = 60309,
       PropPlacement = {0.105, -0.05, 0.205, -45.0, 295.0, 0.0},
       EmoteLoop = true,
       EmoteMoving = true,
       AllowedCommand = false,
   }},
    ["broom"] = {"missheistdocksprep1hold_cellphone", "static", "Broom", AnimationOptions =
    {
        Prop = "prop_tool_broom",
        PropBone = 60309,
        PropPlacement = {0.085, 0.03, 0.0, 280.0, 280.0, 25.0},
        EmoteLoop = true,
        EmoteMoving = true,
        AllowedCommand = false,
    }},
    ["broomanim"] = {"amb@world_human_janitor@male@idle_a", "idle_a", "Broom", AnimationOptions =
    {
        Prop = "prop_tool_broom",
        PropBone = 28422,
        PropPlacement = {-0.005, 0.0, 0.0, 360.0, 360.0, 0.0},
        EmoteLoop = true,
        EmoteMoving = true,
        AllowedCommand = false,
    }},
   ["pizza"] = {"anim@heists@box_carry@", "idle", "Pizza", AnimationOptions =
   {
       ...
       PropBone = 60309,
       PropPlacement = {0.245, 0.08, 0.155, -45.0, 290.0, 0.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   ["pizza2"] = {"anim@heists@box_carry@", "idle", "Pizza", AnimationOptions =
   {
       Prop = "prop_pizza_box_01",
       PropBone = 60309,
       PropPlacement = {0.30, 0.05, 0.205, -60.0, 290.0, 0.0},
       EmoteLoop = true,
       EmoteMoving = true,
   }},
   --0.38,-0.050,15.0,285.0,270.0,2
