...
RegisterNetEvent('animations:client:WalkStart')
AddEventHandler('animations:client:WalkStart', function(args)
  if CanDoEmote then
...
function WalkCommandStart(args, raw)
  if args[1] ~= nil then
    name = args[1]
  else
    name = args
...
RegisterNetEvent('animations:UseWalkingStick')
AddEventHandler('animations:UseWalkingStick', function()
