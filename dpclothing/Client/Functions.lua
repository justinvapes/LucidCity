...
function Notify(message, messageType) -- However you want your notifications to be shown, you can switch it up here.
	if messageType ~= nil then
		exports['lcrp-core']:Notification(message, messageType)
	else
		exports['lcrp-core']:Notification(message, "primary")
	end
end
