...
Config.AllowedVehicles = {
   [1] = {model = "gaz24_taxi", label = "GAZ-24", depositPrice = 50, minGrade = 1},
   [2] = {model = "taxi", label = "Ford Crown Victorian", depositPrice = 100, minGrade = 2},
   [3] = {model = "cla_amg_taxi", label = "Mercedes CLA 45 AMG", depositPrice = 500, minGrade = 3},
   [4] = {model = "escalade_taxi", label = "Cadillac Escalade", depositPrice = 800, minGrade = 4},
   [5] = {model = "amg_gt_taxi", label = "Mercedes AMG GT", depositPrice = 1500, minGrade = 5}
}

Config.Outfits = {
    [1] = {name = 'junior', label = "Junior Driver"},
    [2] = {name = 'driver', label = "Driver"},
    [3] = {name = 'senior', label = "Senior Driver"},
    [4] = {name = 'vip', label = "VIP Driver"},
}
-- NEEDS ECONOMY CHANGES (DEPOSIT PRICE FOR VEHICLE)
Config.DepositPrice = 100
Config.Payment = math.random(40, 60)
