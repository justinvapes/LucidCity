...
local volume = tonumber(GetConvar('voice_defaultVolume', '0.7'))
...
RegisterCommand('control_resetVoice', function()
	if cooldown == 0 then
		cooldown = 10
		local newGrid = getGridZone()
		...
		exports['lcrp-core']:Notification("You have to wait: " .. cooldown .. " seconds before you can reset!", "error")
	end
end)
