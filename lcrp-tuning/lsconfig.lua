...
-- NEEDS ECONOMY CHANGES (PRICES FOR LSCUSTOMS AND BENNYS)
LSC_Config.prices = {

------Window tint------
	windowtint = {
		{ name = "Pure Black", tint = 1, price = 300, DefaultPrice = 300},
		{ name = "Darksmoke", tint = 2, price = 150, DefaultPrice = 150},
		{ name = "Lightsmoke", tint = 3, price = 120, DefaultPrice = 120},
		{ name = "Limo", tint = 4, price = 100, DefaultPrice = 100},
		{ name = "Green", tint = 5, price = 100, DefaultPrice = 100},
	},
...
--------Plates---------
	plates = {
		{ name = "Blue on White 1", plateindex = 0, price = 50, DefaultPrice = 50},
		{ name = "Blue On White 2", plateindex = 3, price = 50, DefaultPrice = 50},
		{ name = "Blue On White 3", plateindex = 4, price = 50, DefaultPrice = 50},
		{ name = "Yellow on Blue", plateindex = 2, price = 75, DefaultPrice = 75},
		{ name = "Yellow on Black", plateindex = 1, price = 100, DefaultPrice = 100},
	},
...
----Wheel accessories----
	wheelaccessories = {
		...
		{ name = "White Tire Smoke",smokecolor = {254,254,254}, price = 300, DefaultPrice = 300},
		{ name = "Black Tire Smoke", smokecolor = {1,1,1}, price = 300, DefaultPrice = 300},
		{ name = "BLue Tire Smoke", smokecolor = {0,150,255}, price = 300, DefaultPrice = 300},
		{ name = "Yellow Tire Smoke", smokecolor = {255,255,50}, price = 300, DefaultPrice = 300},
		{ name = "Orange Tire Smoke", smokecolor = {255,153,51}, price = 300, DefaultPrice = 300},
		{ name = "Red Tire Smoke", smokecolor = {255,10,10}, price = 300, DefaultPrice = 300},
		{ name = "Green Tire Smoke", smokecolor = {10,255,10}, price = 300, DefaultPrice = 300},
		{ name = "Purple Tire Smoke", smokecolor = {153,10,153}, price = 300, DefaultPrice = 300},
		{ name = "Pink Tire Smoke", smokecolor = {255,102,178}, price = 300, DefaultPrice = 300},
		{ name = "Gray Tire Smoke",smokecolor = {128,128,128}, price = 300, DefaultPrice = 300},
	},
...
----------Liveries--------
	[48] = {
		startprice = 1000, DefaultPrice = 1500,
		increaseby = 1000
	},
	
----------Windows--------
	[46] = {
		startprice = 500, DefaultPrice = 750,
		increaseby = 750
	},
...
---------Headlights---------
	[22] = {
		...
		{name = "Xenon Lights", mod = 1, price = 1000, DefaultPrice = 1000},
	},
...
-----------Armor-------------
	[16] = {
		{name = "Armor Upgrade 20%",modtype = 16, mod = 0, price = 1000, DefaultPrice = 1000},
		{name = "Armor Upgrade 40%",modtype = 16, mod = 1, price = 2500, DefaultPrice = 2500},
		{name = "Armor Upgrade 60%",modtype = 16, mod = 2, price = 3500, DefaultPrice = 3500},
		{name = "Armor Upgrade 80%",modtype = 16, mod = 3, price = 5000, DefaultPrice = 5000},
		{name = "Armor Upgrade 100%",modtype = 16, mod = 4, price = 7000, DefaultPrice = 7000},
	},

---------Suspension-----------
	[15] = {
		{name = "Lowered Suspension",mod = 0, price = 500, DefaultPrice = 500},
		{name = "Street Suspension",mod = 1, price = 1000, DefaultPrice = 1000},
		{name = "Sport Suspension",mod = 2, price = 1500, DefaultPrice = 1500},
		{name = "Competition Suspension",mod = 3, price = 2000, DefaultPrice = 2000},
	},

-----------Horn----------
	[14] = {
		{name = "Truck Horn", mod = 0, price = 200, DefaultPrice = 200},
		{name = "Police Horn", mod = 1, price = 200, DefaultPrice = 200},
		{name = "Clown Horn", mod = 2, price = 200, DefaultPrice = 200},
		{name = "Musical Horn 1", mod = 3, price = 200, DefaultPrice = 200},
		{name = "Musical Horn 2", mod = 4, price = 200, DefaultPrice = 200},
		{name = "Musical Horn 3", mod = 5, price = 200, DefaultPrice = 200},
		{name = "Musical Horn 4", mod = 6, price = 200, DefaultPrice = 200},
		{name = "Musical Horn 5", mod = 7, price = 200, DefaultPrice = 200},
		{name = "Sadtrombone Horn", mod = 8, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 1", mod = 9, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 2", mod = 10, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 3", mod = 11, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 4", mod = 12, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 5", mod = 13, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 6", mod = 14, price = 200, DefaultPrice = 200},
		{name = "Calssical Horn 7", mod = 15, price = 200, DefaultPrice = 200},
		{name = "Scaledo Horn", mod = 16, price = 200, DefaultPrice = 200},
		{name = "Scalere Horn", mod = 17, price = 200, DefaultPrice = 200},
		{name = "Scalemi Horn", mod = 18, price = 200, DefaultPrice = 200},
		{name = "Scalefa Horn", mod = 19, price = 200, DefaultPrice = 200},
		{name = "Scalesol Horn", mod = 20, price = 200, DefaultPrice = 200},
		{name = "Scalela Horn", mod = 21, price = 200, DefaultPrice = 200},
		{name = "Scaleti Horn", mod = 22, price = 200, DefaultPrice = 200},
		{name = "Scaledo Horn High", mod = 23, price = 200, DefaultPrice = 200},
		{name = "Jazz Horn 1", mod = 25, price = 200, DefaultPrice = 200},
		{name = "Jazz Horn 2", mod = 26, price = 200, DefaultPrice = 200},
		{name = "Jazz Horn 3", mod = 27, price = 200, DefaultPrice = 200},
		{name = "Jazzloop Horn", mod = 28, price = 200, DefaultPrice = 200},
		{name = "Starspangban Horn 1", mod = 29, price = 200, DefaultPrice = 200},
		{name = "Starspangban Horn 2", mod = 30, price = 200, DefaultPrice = 200},
		{name = "Starspangban Horn 3", mod = 31, price = 200, DefaultPrice = 200},
		{name = "Starspangban Horn 4", mod = 32, price = 200, DefaultPrice = 200},
		{name = "Classicalloop Horn 1", mod = 33, price = 200, DefaultPrice = 200},
		{name = "Classicalloop Horn 2", mod = 34, price = 200, DefaultPrice = 200},
		{name = "Classicalloop Horn 3", mod = 35, price = 200, DefaultPrice = 200},
	},

----------Transmission---------
	[13] = {
		{name = "Street Transmission", mod = 0, price = 2500, DefaultPrice = 2500},
		{name = "Sports Transmission", mod = 1, price = 4500, DefaultPrice = 4500},
		{name = "Race Transmission", mod = 2, price = 6000, DefaultPrice = 6000},
	},
	
-----------Brakes-------------
	[12] = {
		{name = "Street Brakes", mod = 0, price = 3000, DefaultPrice = 3000},
		{name = "Sport Brakes", mod = 1, price = 5500, DefaultPrice = 5500},
		{name = "Race Brakes", mod = 2, price = 7500, DefaultPrice = 7500},
	},
	
------------Engine----------
	[11] = {
		{name = "Engine Upgrade, Level 2", mod = 0, price = 2000, DefaultPrice = 2000},
		{name = "Engine Upgrade, Level 3", mod = 1, price = 4000, DefaultPrice = 4000},
		{name = "Engine Upgrade, Level 4", mod = 2, price = 6000, DefaultPrice = 6000},
	},
