RegisterNetEvent("lcrp-scripts:Client:spawnWheelChair")
AddEventHandler("lcrp-scripts:Client:spawnWheelChair", function()
	LoadModel('prop_wheelchair_01')

	local wheelchair = CreateObject(GetHashKey('prop_wheelchair_01'), GetEntityCoords(PlayerPedId()), true)
end)

RegisterNetEvent("lcrp-scripts:Client:removeWheelChair")
AddEventHandler("lcrp-scripts:Client:removeWheelChair", function()
