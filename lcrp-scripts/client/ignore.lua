...
Citizen.CreateThread(function()
    while true do
		...
		RemoveVehiclesFromGeneratorsInArea(335.2616 - 300.0, -1432.455 - 300.0, 46.51 - 300.0, 335.2616 + 300.0, -1432.455 + 300.0, 46.51 + 300.0); -- Hospital
		RemoveVehiclesFromGeneratorsInArea(441.8465 - 500.0, -987.99 - 500.0, 30.68 -500.0, 441.8465 + 500.0, -987.99 + 500.0, 30.68 + 500.0); -- police desk
		...
		RemoveVehiclesFromGeneratorsInArea(-458.24 - 300.0, 6019.81 - 300.0, 31.34 - 300.0, -458.24 + 300.0, 6019.81 + 300.0, 31.34 + 300.0); -- police paleto
		RemoveVehiclesFromGeneratorsInArea(1854.82 - 300.0, 3679.4 - 300.0, 33.82 - 300.0, 1854.82 + 300.0, 3679.4 + 300.0, 33.82 + 300.0); -- police sandy
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedBeingStunned(ped) then
			SetPedMinGroundTimeForStungun(GetPlayerPed(-1), 2000)
		else
			Citizen.Wait(1000)
		end
	end
...
Citizen.CreateThread(function()
	...
	SetWeaponDamageModifier(GetHashKey('WEAPON_BAT'), 0.25)
	...
	SetWeaponDamageModifier(GetHashKey('WEAPON_MICROSMG'), 0.9)
end)
