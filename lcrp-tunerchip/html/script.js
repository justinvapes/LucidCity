...
$(document).on('click', '#save', function(){
    $.post('http://lcrp-tunerchip/save', JSON.stringify({
...
$(document).on('click', '#reset', function(){
    $.post('http://lcrp-tunerchip/reset');
});
...
$(document).on('click', "#save-neon", function(){
    if (RainbowNeon) {
        $.post('http://lcrp-tunerchip/saveNeon', JSON.stringify({
...
$(document).on('click', '#save-headlights', function(){
    $.post('http://lcrp-tunerchip/saveHeadlights', JSON.stringify({
        value: headlightVal,
...
$(document).on('click', '#save-stancer', function(){
    ...
    $.post('http://lcrp-tunerchip/SetStancer', JSON.stringify({
...
QBTuner.Open = function() {
    $.post('http://lcrp-tunerchip/checkItem', JSON.stringify({item: "tunerlaptop"}), function(hasItem){
        if (hasItem) {
