WeaponDamageList = {
	["WEAPON_UNARMED"] = "Fist wound",
	["WEAPON_ANIMAL"] = "Bite wound of an animal",
	["WEAPON_COUGAR"] = "Bite wound of an animal",
	["WEAPON_KNIFE"] = "Stab wound",
    ["WEAPON_NIGHTSTICK"] = "Bump of a stick or something",
    ["WEAPON_BREAD"] = "Dent in your head from bread!",
	["WEAPON_HAMMER"] = "Bump of a stick or something",
	["WEAPON_BAT"] = "Bump of a stick or something",
	["WEAPON_GOLFCLUB"] = "Bump of a stick or something",
	["WEAPON_CROWBAR"] = "Bump of a stick or something",
	...
	["WEAPON_FIREEXTINGUISHER"] = "Unknow",
	["WEAPON_PETROLCAN"] = "Fuel Damage",
	...
	["WEAPON_EXPLOSION"] = "Burns (of explosive)",
            ...
            if bleedTickTimer >= Config.BleedTickRate and not isInHospitalBed then
                if not isDead and not InLaststand then
                    if isBleeding > 0 then 
                        ...
                        TriggerServerEvent("evidence:server:CreateBloodDrop", scCore.Functions.GetPlayerData().citizenid, scCore.Functions.GetPlayerData().metadata["bloodtype"], coords)
...
AddEventHandler('hospital:client:UseBandage', function()
    scCore.TaskBar("use_bandage", "Using bandage", 4000, false, true, {
        ...
        TriggerServerEvent("scCore:Server:RemoveItem", "bandage", 1)
        TriggerEvent("inventory:client:ItemBox", scCore.Shared.Items["bandage"], "remove")
...
AddEventHandler('hospital:client:UsePainkillers', function()
    scCore.TaskBar("use_bandage", "Using painkillers", 3000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        TriggerServerEvent("scCore:Server:RemoveItem", "painkillers", 1)
        TriggerEvent("inventory:client:ItemBox", scCore.Shared.Items["painkillers"], "remove")
        onPainKillers = true
