...
AddEventHandler("diceroll:client:roll", function(sourceId, maxDinstance, rollTable, sides)
    ...
    ShowRoll(rollString, GetPlayerFromServerId(sourceId), maxDinstance, offset, sourceId)
end)

function ShowRoll(text, sourcePlayer, maxDistance, offset, sourceId)
    local display = true
    ...
    Citizen.CreateThread(function()
        ...
        while display do
            ...
            if dist < maxDistance then
                if dist == 0 and GetPlayerServerId(PlayerId()) == sourceId then
