...
Config.ArcadeLocation = vector3(335.71, -912.27, 29.25)
...
Config.Arcade = {
    {
        NPC = {
            position = vector3(337.12, -907.74, 28.29),
            heading = 359.63,
            model = "a_m_y_indian_01",
        },
        blip = {
            position = vector3(337.12, -907.74, 29.25),
            blipId = 606,
            scale = 1.0,
            color = 0,
            name = "Arcade house",
        ...
        marker = {
            markerPosition = vector3(337.03, -906.10, 28.80),
            markerType = 23,
            options = {
...
Config.computerList = {
    -- Retro machines
    {
        ...
        markerType = 20,
        position = vector3(325.79, -912.94, 29.25),
        markerOptions = {
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(323.79, -915.65, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 255, g = 255, b = 255, a = 125 },
            rotate = true,
    ...
    -- Gaming computers
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(324.69, -904.27, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(328.01, -904.25, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(331.35, -904.29, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(336.92, -903.16, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(340.35, -903.11, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
    ...
    },
    {
        ...
        computerCPU = Config.CPUList[2],
        markerType = 20,
        position = vector3(343.85, -902.89, 29.25),
        markerOptions = {
            scale = { x = 0.5, y = 0.5, z = 0.5 },
            color = { r = 125, g = 125, b = 255, a = 125 },
            rotate = true,
