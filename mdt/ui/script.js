const mdtApp = new Vue({
    ...
    methods: {
        ...
        ReleaseVehicle(vehicle) {
            ...
            $.post('http://mdt/ReleaseVehicle', JSON.stringify({
                vehiclePlate: vehicle.plate,
                vehicleModel: vehicle.vehicle,
            }));
            this.changePage("Search Vehicles");
            this.vehicle_search = "";
            this.vehicle_results.query = null;
            this.vehicle_results.results = null;
            this.vehicle_search = null;
    ...
    if (document.readyState === "complete") {
        window.addEventListener('message', function(event) {
            if (event.data.type == "enable") {
                ...
                mdtApp.officer.callsign = event.data.callsign;
