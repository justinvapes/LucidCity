...
Config.DropPrice = math.random(50, 100)

Config.TowLabel = "Tow Vehicle"

Config.TowLocation = {
    mechanic  = {x = -207.15, y = -1347.52, z = 31.5, h = 90.00},
    mechanic2 = {x = -370.24, y = -107.67, z = 38.68, h = 64.00},
}
